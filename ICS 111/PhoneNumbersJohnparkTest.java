...
public class PhoneNumbersJohnparkTest {
   ...
   @Test public void phoneAreaTest() {
      String s = "";
      int val = 0;
      boolean is799 = false;
      for(int i = 0; i < 10000; i++){
         s = PhoneNumbersJohnpark.generateNumber();
         s = s.substring(1,4);
         try{
   ...
   /** A test that always fails. **/
   @Test public void phoneLastTest() {
      String s = "";
      int val = 0;
      ...
      //System.out.println(val);
         ...
         Assert.assertTrue("Last 4 not printing four digits or spaces in output",(s.length() == 4));
