...
Bubba Smith 20 2.2
Record #0 was correctly located in file  "students.txt". 
...
Enter first name, last name, age, and gpa separated by spaces: 
Surfer Dude 40 4.0
Record #5 was correctly located in file  "students.txt". 
...
Enter first name, last name, age, and gpa separated by spaces: 
Sally Suzuki 29 3.3
Record #1 was correctly located in file  "students.txt". 
